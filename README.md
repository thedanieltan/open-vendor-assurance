...
OpenVA can also be shared as a free public-source metadata dataset. GitHub remains the source of truth; external listings should point back to this repository and the browser app.

Repo-side publishing assets:
...
Use these assets to mirror OpenVA to Hugging Face Datasets, Kaggle Datasets, Zenodo, and open-data directories while keeping the non-advisory boundary visible.
