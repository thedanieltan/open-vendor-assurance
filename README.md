...
OpenVA should export a universal dataset/pack format. OpenVA is independent public infrastructure, not a module folder for any single downstream product.
...
P1: native schema and validation substrate.
